...
EXTRA_OECMAKE += " \
    ...
    -DDEFAULT_PROJECT_VERSION_SUFFIX=${PRODUCT_VERSION_SUFFIX} \
    -DDEFAULT_PROJECT_VERSION_CODENAME=${PRODUCT_VERSION_CODENAME} \
    -DDEFAULT_PROJECT_DESCRIPTION=${PRODUCT_DESCRIPTION} \
